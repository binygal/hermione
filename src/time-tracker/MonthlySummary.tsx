...
export default function MonthlySummary(props: MonthlySummaryProps) {
  ...
  const time = `${timeToCompletion.hours.toString().padStart(2, '0')}:${timeToCompletion.minutes.toString().padStart(2, '0')}`;
  const timeToCompletionElement = timeToCompletion.hours === 0 && timeToCompletion.minutes === 0
